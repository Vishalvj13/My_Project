...
const Accountant = () => {
  ...
  const[releaseToggleFlag,setReleaseToggleFlag]=useState(false)
  ...
  const SetInvoiceModal = (patient) => {
   ...
   //   to toggle the modal flag
  const SetReleaseModal = (patient) => {
    GetPatientBillFromServer(patient.patId);
    setPatient(patient);
    handleShow();
    setReleaseToggleFlag(true);
  };
  // to load the bill
  ...
  //set invoice button flag
  const SetInvoiceButttonFlag=()=>{
    console.log("------"+invoiceToggleFlag);
    setInvoiceToggleFlag(true);
    console.log("------"+invoiceToggleFlag);
  }
  ...
  return (
    <div>
      ...
      <table className="table table-bordered" >
        ...
        <tbody >
        {patients.map((p) => {
            return <Patient patient={p} SetReleaseModal={SetReleaseModal} SetInvoiceModal={SetInvoiceModal} />;
          })}
        </tbody>
      </table>
